function L0_SLP = getL0_SLP(startDate, endDate)
%getG0_SLP Provide standard load profile for business agents (agricultural)
...
%   endDate   - Last date of SLP curve, complete day is considered (datetime)
    ...
    % Create Laod Profile %
    %%%%%%%%%%%%%%%%%%%%%%%
    load('BoundaryConditions.mat', 'SLP_L0');
    L0_SLP = getSLP(SLP_L0, time, ...
                    maskWinter, maskIntermediate, maskSummer, ...
